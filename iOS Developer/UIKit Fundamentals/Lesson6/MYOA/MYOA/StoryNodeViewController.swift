...
class StoryNodeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let nextVC = self.storyboard?.instantiateViewController(withIdentifier: "StoryNodeViewController") as! StoryNodeViewController
        
        nextVC.storyNode = storyNode.storyNodeForIndex(index: indexPath.row)
